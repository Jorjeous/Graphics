...
int main( void )
{
	...
	do{
        ...
        GLuint MatrixID2 = glGetUniformLocation(programID2, "MVP2");
        ...
        float camX =4;// sin(glfwGetTime()) * radius;
        float camZ =4;// cos(glfwGetTime()) * radius;

        glm::mat4 View;

        View = glm::lookAt(
                glm::vec3(camX,3,camZ), // Camera is at (4,3,3), in World Space
